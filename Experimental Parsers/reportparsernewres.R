...
coa_plot <- function(x,y,x_txt,y_txt,l_txt,pt_b,pt_c,fb,gr_t,labels,l_color="black", so)
{
        ...
        png(filename=dev_fn, width=1400, height=700, units = "px", res=300) # Open a device: bmp & pdf are other options here
        ...
        if (pt_b) {
                ...
                mtext(paste("SO:", so), side=3, adj=0, line=2, cex=0.4)
                mtext(labels[4], side=3, line=1, adj=1, cex=0.4)
                mtext(labels[5], side=3, line=0, adj=1, cex=0.4)
        }
        
        if(pt_c) {
                #textxy(x_txt, 0.96*y_txt, l_txt, cex=1, offset=-0.8)
                text(min(x), max(ylim), labels=l_txt, pos=4, offset=-1)
                mtext (labels[9], side=3, adj=0, cex=0.4)
                mtext(paste("SO:", so), side=3, adj=0, line=2, cex=0.4)
                mtext(labels[3], side=3, line=1, adj=1, cex=0.4)
                mtext(labels[4], side=3, line=0, adj=1, cex=0.4)
        }
        ...
        png(filename=fn, width=680, height=500, units = "px",res=300)
        par(cex=0.4, lwd=0.6)# Open a device: bmp & pdf are other options here
        if (pt_b) {
                ylim <- c(0,105)
                } else {
                        ylim <- range(y)
        ...
        if (pt_b) {
                ...
                text(min(x),max(ylim), labels[3], pos=4, offset=-1, cex=0.4)
                mtext(paste("SO:", so), side=3, adj=0, line=2, cex=0.4)
                mtext(labels[4], side=3, line=0.7, adj=1, cex=0.4)
                mtext(labels[5], side=3, line=0, adj=1, cex=0.4)
        }
        if(pt_c) {
                text(min(x), max(ylim), labels=l_txt, pos=4, offset=-1, cex=0.4)
                mtext(paste("SO:", so), side=3, adj=0, line=2, cex=0.4)
                mtext (labels[9], side=3, adj=0, cex=0.4)
                mtext(labels[3], side=3, line=0.7, adj=1, cex=0.4)
                mtext(labels[4], side=3, line=0, adj=1, cex=0.4)
        }
